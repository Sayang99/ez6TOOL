...
echo $ku"["$me"13"$ku"]"$i" SPAM SMS BRUTAL -OFF SAMPE LEBARAN"
...
then
clear
figlet -f slant "J U S T W A I T"|lolcat
sleep 1
...
then
clear
figlet -f slant "J U S T W A I T"|Ulolcat
sleep 2
...
sleep 2
echo $ku"Facebook :"$i" noname.nonameya"
echo $ku"YouTube  :"$i" YouTube E Z 01"
echo $ku"WhatsApp :"$i" 08228890xxxx"
sleep 2
echo $pur"Terima kasih Yang Sudah Memakai Tool ini"
sleep 2
echo $pur"SUBSCRIBE MY CHANNEL { YOUTUBE E Z 01 }"
exit
fi
